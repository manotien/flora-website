...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:Arial, sans-serif">
    ...
    <script type="text/javascript" src="{{url('')}}/public/js/jssor.slider.mini.js"></script>
    ...
    <style>
        ...
        */
        ...
        .jssort01 .c {
            ...
            background: url('/public/img/t01.png') -800px -800px no-repeat;
            _background: none;
        }
    ...
    <div id="jssor_1" style="position: relative; margin: 0 ; top: 0px; left: 500px; width: 700px; height: 480px; overflow: hidden; visibility: hidden; background-color: #ffffff;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 380px; height: 500px; overflow: hidden;">
            
            @foreach ($flora->floraphotos as $photo)
            <div data-p="144.50" style="display: none;">
                <img data-u="image" src="{{url('')}}/public/photo/{{$photo->file_name}}" />
                <img data-u="thumb" src="{{url('')}}/public/photo/{{$photo->file_name}}" />
            </div>
            @endforeach
        
        </div>
        <!-- Thumbnail Navigator -->
        <div data-u="thumbnavigator" class="jssort01" style="position:absolute;left:0px;bottom:0px;width:370px;height:100px;" >
